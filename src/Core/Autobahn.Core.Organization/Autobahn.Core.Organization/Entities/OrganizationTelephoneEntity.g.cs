...
public partial class OrganizationTelephoneEntity : EntityBase, IOrganizationTelephone
{
    ...
    /// <summary>
    /// Reference to an optional instance of the <see cref="RefOrganizationTelephoneNumberListedStatus"/> model
    /// </summary>
    [ForeignKey("RefOrganizationTelephoneNumberListedStatus")]
    public Guid? RefOrganizationTelephoneNumberListedStatusId { get; set; }
    ...
    /// <summary>
    /// Reference to an optional instance of the <see cref="IRefOrganizationTelephoneNumberListedStatus"/> implementation
    /// <remarks>
    /// This entity is in the Organization domain
    /// </remarks>
    /// </summary>
    public virtual RefOrganizationTelephoneNumberListedStatusEntity? RefOrganizationTelephoneNumberListedStatusEntity { get; set; }
