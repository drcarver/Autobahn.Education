...
//* FileName:   IepauthorizationViewModel.g.cs
//***************************************************************************

/// <summary>
/// The IIepauthorization file
/// </summary>
public partial class IepauthorizationViewModel : ObservableValidator, IIepauthorization
{
    #region "IepauthorizationViewModel Constructor"
    /// </summary>
    ...
    /// <summary>
    /// IepauthorizationViewModel Constructor
    /// </summary>
    public IepauthorizationViewModel(System.IServiceProvider provider)
    {
        serviceProvider = provider;
        OnIepauthorizationViewModelConstruction();
    }

    /// <summary>
    /// IepauthorizationViewModel Constructor partial method
    /// <para>
    ...
    /// </para>
    /// </summary>
    partial void OnIepauthorizationViewModelConstruction();
    #endregion"

    #region "Backing Fields"
    // Every viewmodel has a Title property
    private string viewTitle = "Hello from Iepauthorization";
