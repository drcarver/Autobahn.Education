...
//* FileName:   ProgramParticipationTitleIiilepViewModel.g.cs
//***************************************************************************

/// <summary>
/// The IProgramParticipationTitleIiilep file
/// </summary>
public partial class ProgramParticipationTitleIiilepViewModel : ObservableValidator, IProgramParticipationTitleIiilep
{
    #region "ProgramParticipationTitleIiilepViewModel Constructor"
    /// </summary>
    ...
    /// <summary>
    /// ProgramParticipationTitleIiilepViewModel Constructor
    /// </summary>
    public ProgramParticipationTitleIiilepViewModel(System.IServiceProvider provider)
    {
        serviceProvider = provider;
        OnProgramParticipationTitleIiilepViewModelConstruction();
    }

    /// <summary>
    /// ProgramParticipationTitleIiilepViewModel Constructor partial method
    /// <para>
    ...
    /// </para>
    /// </summary>
    partial void OnProgramParticipationTitleIiilepViewModelConstruction();
    #endregion"

    #region "Backing Fields"
    // Every viewmodel has a Title property
    private string viewTitle = "Hello from ProgramParticipationTitleIiilep";
