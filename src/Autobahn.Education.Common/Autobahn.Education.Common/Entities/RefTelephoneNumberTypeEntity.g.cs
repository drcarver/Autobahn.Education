...
//* FileName:   RefTelephoneNumberTypeEntity.g.cs
//* Name:       Telephone Number Type
//* Definition: The type of communication number listed for a person.
//***************************************************************************

/// <summary>
/// Telephone Number Type <see cref="RefTelephoneNumberType"/>
/// <para>
...
public partial class RefTelephoneNumberTypeEntity : ReferenceBaseEntity, IReferenceBase
{
}
