...
/// </summary>
[Table("AssessmentRegistration", Schema = "Common")]
public partial class AssessmentRegistrationEntity : EntityBase, IAssessmentRegistration
{
    ...
    /// </para>
    /// </summary>
    [Obsolete("The RefGradeLevelToBeAssessed property is obsolete and will be removed in a later version")]
    ...
    /// </para>
    /// </summary>
    [Obsolete("The RefGradeLevelWhenAssessed property is obsolete and will be removed in a later version")]
