...
//* FileName:   CourseSectionLocationViewModel.g.cs
//***************************************************************************

/// <summary>
/// The ICourseSectionLocation file
/// </summary>
public partial class CourseSectionLocationViewModel : ObservableValidator, ICourseSectionLocation
{
    #region "CourseSectionLocationViewModel Constructor"
    /// </summary>
    ...
    /// <summary>
    /// CourseSectionLocationViewModel Constructor
    /// </summary>
    public CourseSectionLocationViewModel(System.IServiceProvider provider)
    {
        serviceProvider = provider;
        OnCourseSectionLocationViewModelConstruction();
    }

    /// <summary>
    /// CourseSectionLocationViewModel Constructor partial method
    /// <para>
    ...
    /// </para>
    /// </summary>
    partial void OnCourseSectionLocationViewModelConstruction();
    #endregion"

    #region "Backing Fields"
    // Every viewmodel has a Title property
    private string viewTitle = "Hello from CourseSectionLocation";
    ...
    /// </para>
    /// </summary>
    [DisplayName("Receiving Location of Instruction")]
