...
//* FileName:   RefFinancialAccountProgramCodeEntity.g.cs
//* Name:       Financial Account K12 Program Code
//* Definition: A program is a plan of activities and procedures designed to accomplish a predetermined objective or set of objectives.  The program classification provides the school district with a framework to classify instructional and other expenditures by program to determine cost.
//***************************************************************************

/// <summary>
/// Financial Account K12 Program Code <see cref="RefFinancialAccountProgramCode"/>
/// <para>
...
/// </para>
/// </summary>
[Table("RefFinancialAccountProgramCode", Schema = "Common")]
...
public partial class RefFinancialAccountProgramCodeEntity : ReferenceBaseEntity, IReferenceBase
{
}
