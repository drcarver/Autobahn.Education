...
public partial class IepauthorizationEntity : EntityBase, IIepauthorization
{
    ...
    /// <summary>
    /// Reference to an optional instance of the <see cref="IAuthorizationDocument"/> implementation
    /// <remarks>
    /// This entity is in the Invalid domain
    /// </remarks>
    /// </summary>
    public virtual AuthorizationDocumentEntity AuthorizationDocumentEntity { get; set; }
