...
//* FileName:   ElorganizationFundViewModel.g.cs
//***************************************************************************

/// <summary>
/// The IElorganizationFund file
/// </summary>
public partial class ElorganizationFundViewModel : ObservableValidator, IElorganizationFund
{
    #region "ElorganizationFundViewModel Constructor"
    /// </summary>
    ...
    /// <summary>
    /// ElorganizationFundViewModel Constructor
    /// </summary>
    public ElorganizationFundViewModel(System.IServiceProvider provider)
    {
        serviceProvider = provider;
        OnElorganizationFundViewModelConstruction();
    }

    /// <summary>
    /// ElorganizationFundViewModel Constructor partial method
    /// <para>
    ...
    /// </para>
    /// </summary>
    partial void OnElorganizationFundViewModelConstruction();
    #endregion"

    #region "Backing Fields"
    // Every viewmodel has a Title property
    private string viewTitle = "Hello from ElorganizationFund";
    ...
    /// </summary>
    public void Load(IElorganizationFund model)
    {
        IsBusy = true;
        Id = model.Id;
